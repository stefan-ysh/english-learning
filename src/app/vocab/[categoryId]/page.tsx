    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-4 md:p-24 bg-gray-50 dark:bg-gray-950">
            <div className="z-10 max-w-5xl w-full flex items-center justify-between font-mono text-sm lg:flex mb-12">
                <Link href="/vocab" className="flex items-center gap-2 text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">
                    <ArrowLeft className="w-5 h-5" /> {t("btn.back")}
                </Link>
                <h1 className="text-2xl font-bold">{t(`cat.${category.id}`)}</h1>
                <div className="w-16"></div>
            </div>

            <div className="grid w-full max-w-xl gap-6">
                <Link
                    href={`/vocab/${category.id}/learn`}
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">{t("learn.vocab.desc")}</p>
                    </div>
                </Link>

                <Link
                    href={`/vocab/${category.id}/quiz`}
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">{t("quiz.vocab.desc")}</p>
                    </div>
                </Link>
            </div>
        </main>
